...
class Storage:
    ...
    def filter_by(self, **kwargs):
        for id_, item in enumerate(self, 1):
...
if __name__ == '__main__':
    ...
    storage.add(Scanner.create(3, vendor="Samsung", model="X4220"))
    storage.add(Scanner.create(2, vendor="Samsung", model="X4222"))
    storage.add(Xerox.create(3, vendor="Sony", model="W9010"))
    print(storage)

    for idx, itm in storage.filter_by(department=None, vendor="Samsung", model="X4220"):
